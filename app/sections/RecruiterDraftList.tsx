...
const drafts: DraftProps[] = [
  { title: "Frontend Development Internship", org: "Tech Solutions Inc.", involvement: "Full-time", type: "Internship", locations: ["Bengaluru", "Remote"], stipend: "25", units: "k" },
  { title: "AI Research Assistant", org: "AI Labs", involvement: "Part-time", type: "Research", locations: ["Hyderabad"], stipend: "0", units: "" },
  { title: "Marketing & Outreach Intern", org: "GreenEarth NGO", involvement: "Full-time", type: "Internship", locations: ["Mumbai", "Remote"], stipend: "10", units: "k" },
  { title: "Product Management Trainee", org: "InnovateX Pvt. Ltd.", involvement: "Full-time", type: "Trainee", locations: ["Chennai"], stipend: "1.2", units: "l" },
  { title: "Business Strategy Intern", org: "Global Ventures", involvement: "Part-time", type: "Internship", locations: ["Delhi", "Remote"], stipend: "3", units: "l" },
];

const RecruiterDraftList = () => {
    ...
    <div className={`flex h-screen w-full ${dm_sans.className} bg-zinc-50`}>
      ...
      <div className="flex-1 flex flex-col bg-white overflow-auto">
        <div className="p-8 w-full">
            <h1 className="text-3xl font-bold mb-6 text-black">My Drafts</h1>
...
export default RecruiterDraftList;
